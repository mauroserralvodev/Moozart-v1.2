...
export const LandingFooter = () => {
    ...
    <section>
      ...
      <div className="mx-auto max-w-screen-xl">
          ...
          <section className={space2.className}>
              <span className="text-sm text-black sm:text-center ">©2024 <a href="https://moozart.net" className="hover:underline">Moozart AI</a> - All Rights Reserved.</span>
              </section>
              <div className="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
                  ...
                  <a href="https://www.instagram.com/moozart.ai/" className="text-black hover:text-gray-900 ">
                  ...
                  <a href="https://github.com/moozartai" className="text-black hover:text-gray-900 ">
