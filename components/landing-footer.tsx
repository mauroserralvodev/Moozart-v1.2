      ...
      <div className="mx-auto max-w-screen-xl">
              ...
              <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                  <div>
                      ...
                      <ul className="text-gray-600 dark:text-gray-400">
                          <li className="mb-4">
                              <a href="https://moozart.es" className="hover:underline">Noticias</a>
                          </li>
                          <li>
          ...
          <div className="sm:flex sm:items-center sm:justify-between">
              ...
              <div className="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
                  ...
                  <a href="https://www.instagram.com/moozart.ai/" className="text-gray-500 hover:text-gray-900 dark:hover:text-white">
                  ...
                  <a href="https://github.com/moozartai" className="text-gray-500 hover:text-gray-900 dark:hover:text-white">
