...
export const LandingFooter = () => {
    return (
    <section>
      <footer className="p-8 border bg-white border-gray-200 shadow-md rounded-lg m-10 mt-0 mb-20 sm:p-6 ">
      <div className="mx-auto max-w-screen-xl">
          <div className="md:flex md:justify-between">
              <div className="mb-6 md:mb-0">
                  <a href="https://moozart.net" className="flex items-center">
              ...
              <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                  ...
                  <section className={space.className}>
                      <h2 className="mb-4 text-sm font-semibold text-gray-900 uppercase ">Actualizaciones</h2>
                  </section>
                  ...
                  <section className={space.className}>
                      <h2 className="mb-4 text-sm font-semibold text-gray-900 uppercase ">Síguenos</h2>
                  </section>
                  <section className={space2.className}>
                      <ul className="text-gray-600 ">
                          <li className="mb-4">
                          ...
                          <li>
                              <a href="https://discord.gg/EvnqHmUEdj" className="hover:underline">Discord</a>
                          </li>
                      </ul>
                      </section>
                  </div>
          ...
          <section className={space2.className}>
              <span className="text-sm text-gray-500 sm:text-center ">©2024 <a href="https://moozart.net" className="hover:underline">Moozart AI</a> - All Rights Reserved.</span>
              </section>
              <div className="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
                  ...
                  <a href="https://www.instagram.com/moozart.ai/" className="text-gray-500 hover:text-gray-900 ">
                  ...
                  <a href="https://github.com/moozartai" className="text-gray-500 hover:text-gray-900 ">
