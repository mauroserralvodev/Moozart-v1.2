...
<section className="bg-white dark:bg-gray-900">
    <section className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
        <h1 className="flex items-center text-5xl font-extrabold dark:text-white">Moozart<span className="bg-gray-200 text-black text-2xl font-extrabold mr-2 px-2.5 py-0.5 rounded dark:bg-blue-200 dark:text-blue-800 ml-2">PRO</span></h1>
    </section>
