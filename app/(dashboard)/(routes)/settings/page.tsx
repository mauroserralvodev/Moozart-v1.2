...
<section className={space2.className}>
  ...
  <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
      ...
      <section className={space.className}>
          <h2 className="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 ">Time to <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-600 to-yellow-500">Elevate your sound</span></h2>
      </section>
      ...
      <div className="select-none space-y-8 lg:grid lg:grid-cols-3 sm:gap-6 xl:gap-10 lg:space-y-0">
          ...
          <section className={space.className}>
              ...
              <p className="font-light text-gray-500 sm:text-lg ">Mejor opcion para probar las funciones.</p>
          ...
          <div className="shadow-lg -translate-y-2 hover:shadow-lg transition flex flex-col p-6 mx-auto max-w-lg text-center text-gray-900 bg-white rounded-lg border border-gray-200 xl:p-8">
          <section className={space.className}>
              <h3 className="mb-4 text-3xl font-extrabold">PRO</h3>
             </section>
              <p className="font-light text-gray-500 sm:text-lg ">La alternativa para productores, dj o creadores de contenido online.</p>
              <div className="flex justify-center items-baseline my-8">
              <section className={space.className}>
          ...
          <section className={space.className}>
              ...
              <p className="font-light text-gray-500 sm:text-lg ">Mejor opcion para uso comercial o publicitario.</p>
              <div className="flex justify-center items-baseline my-8">
              <section className={space.className}>
