...
const Error = () => {
  return ( 
    ...
    <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12">
        <a href="https://www.binance.com/es/blog/all/binance-chain-la-blockchain-para-intercambiar-el-mundo-304219301536473088" className="inline-flex justify-between items-center py-1 px-1 pr-4 mb-7 text-sm text-gray-700 bg-gray-100 rounded-full  hover:bg-gray-200  shadow-lg" role="alert">
        ...
        <div className="flex flex-col mb-8 lg:mb-16 space-y-4 sm:flex-row sm:justify-center sm:space-y-0 sm:space-x-4">
            <a href="https://www.binance.com/" className="shadow-lg inline-flex justify-center items-center py-3 px-5 text-base font-medium text-center text-white rounded-lg bg-black hover:bg-primary-800 ">
                Saber más
            ...
            <a href="https://www.youtube.com/@moozartai" className="shadow-lg inline-flex justify-center items-center py-3 px-5 text-base font-medium text-center text-gray-900 rounded-lg border border-gray-300 hover:bg-gray-100 ">
...
<section className="bg-white ">
    <div className="gap-8 items-center py-8 px-4 mx-auto max-w-screen-xl xl:gap-16 md:grid md:grid-cols-2 sm:py-16 lg:px-6">
        ...
        <section className={space.className}>
            ...
            <p className="mb-6 font-light text-gray-500 md:text-lg ">En Moozart, elegimos utilizar la Binance Smart Chain (BSC) debido a su alta velocidad, bajo costo y compatibilidad con la red Ethereum. La BSC utiliza un mecanismo de consenso de prueba de participaci&oacute;n delegada (DPoS), lo que permite una mayor velocidad y eficiencia en el procesamiento de transacciones. Adem&aacute;s, la BSC tiene una cadena secundaria llamada Binance Chain, que permite una transacci&oacute;n m&aacute;s r&aacute;pida y econ&oacute;mica.</p>
            <a href="https://www.binance.com/" className="shadow-lg inline-flex items-center border border-black text-black bg-white hover:bg-black hover:text-white font-medium rounded-lg text-sm px-5 py-2.5 text-center ">
                Ver más
                <svg className="ml-2 -mr-1 w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" d="M10.293 3.293a1 1 0 011.414 0l6 6a1 1 0 010 1.414l-6 6a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-4.293-4.293a1 1 0 010-1.414z" clip-rule="evenodd"></path></svg>
            </a>
        </div>
...
<section className="bg-white  mt-20">
  <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
      ...
      <section className={space.className}>
          <h2 className="mb-4 text-3xl tracking-tight font-extrabold text-gray-900 sm:text-4xl ">Nuestra Newsletter</h2>
      </section>
          <p className="mx-auto mb-8 max-w-2xl font-light text-md text-gray-500 md:mb-12 ">Para estar al día de los avances de la hoja de ruta, anuncios y descuentos exclusivos,suscribete con tu email.</p>
          <form action="#">
              <div className="items-center mx-auto mb-3 space-y-4 max-w-screen-sm sm:flex sm:space-y-0">
                  <div className="relative w-full">
                      <label className="hidden mb-2 text-sm font-medium text-gray-900 ">Email</label>
              ...
              <div className="mx-auto max-w-screen-sm text-sm text-center text-gray-400 newsletter-form-footer "><a href="#" className="font-medium text-primary-600 hover:underline">Al introducir tu correo electrónico aceptas automáticamente nuestra política de privacidad</a>.</div>
          </form>
      </div>
  </div>
</section>
<footer className="bg-white rounded-lg sm:flex sm:items-center sm:justify-between p-4 sm:p-6 xl:p-8  antialiased">
