  ...
  return (
    ...
    <div className="relative bg-white sm:rounded-lg">
      ...
      <h1 className="m-10 text-4xl font-extrabold">Marketplace</h1>
        ...
        <button data-popover-target="popover-click" data-popover-trigger="click" type="button" className="text-black border border-black bg-white hover:bg-black hover:text-white font-medium rounded-lg text-sm px-5 py-2.5 text-center ">Añadir</button>
...
<div className="hs-tooltip inline-block [--trigger:hover] [--placement:bottom]">
  <button type="button" className="hs-tooltip-toggle flex justify-center items-center size-10 text-sm font-semibold rounded-lg border border-gray-200 bg-white text-gray-800 shadow-sm hover:bg-gray-50 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-white dark:hover:bg-gray-800 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600">
    Añadir
    <span className="px-3 py-2 bg-gray-100 border-b border-gray-200 rounded-t-lg font-semibold text-gray-900 hs-tooltip-content hs-tooltip-shown:opacity-100 hs-tooltip-shown:visible opacity-0 transition inline-block absolute invisible z-10  border text-sm  rounded-lg shadow-md" role="tooltip">
        No tienes canciones
    </span>
  </button>
</div>
