...
<section className={space2.className}>
  ...
  <li className="inline-flex items-center">
    <a className="flex items-center font-semibold text-sm text-black hover:text-blue-600 focus:outline-none focus:text-blue-600 dark:focus:text-blue-500" href="/news/9LKa7Nb48FAp">
      Articulos
    </a>
  </li>
</ol>
              <address className="flex items-center mb-6 not-italic">
                  <div className="inline-flex items-center mr-3 text-sm text-gray-900 dark:text-white">
                     <img className="mr-4 w-16 h-16 rounded-full" src="/onelogo.png" alt="Mauro Serralvo"></img>
                      <div>
          ...
          <figure>
          <img className="shadow-lg border-black-10px rounded-lg w-full h-full" src="/articulo4.avif" alt="Imagen News"></img>
