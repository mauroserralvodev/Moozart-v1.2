...
<ol className="flex items-center whitespace-nowrap mb-7" aria-label="Breadcrumb">
  ...
  <li className="inline-flex items-center">
    <a className="flex items-center font-semibold text-sm text-black hover:text-blue-600 focus:outline-none focus:text-blue-600 dark:focus:text-blue-500" href="/news/H8uf5TngNMV6pl">
      Articulos
    </a>
  </li>
</ol>
