...
<section className={space2.className}>
  ...
  <div className="flex justify-between px-4 mx-auto max-w-screen-xl ">
      <article className="mx-auto w-full max-w-2xl format format-sm sm:format-base lg:format-lg format-blue dark:format-invert">
          ...
          <p className="mb-2 lead">La Suscripción Pro ofrece una experiencia premium con creación ilimitada de proyectos, descargas de alta calidad y futuro almacenamiento seguro por 3.99€ al mes.</p>
          <p className="mb-8">La Suscripción Custom, dirigida a empresas y producciones grandes, incluye la cesión total del copyright y todas las ventajas de la Suscripción Pro por 24.98€ al mes.</p>

          <figure>
          <img className="shadow-lg border-black-10px rounded-lg w-full h-full" src="/articulo3.avif" alt="Imagen News"></img>
